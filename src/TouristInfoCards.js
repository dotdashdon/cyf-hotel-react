  ...
  return (
    <div>
      <div className="card">
        ...
        <div className="card-body">
          <p className="description">
            Explore the city and discover hidden treasures, intriguing history,
            fantastic food, and spectacular architecture. Enjoy a guided tour of
            Manchester with a local to uncover the city’s story, whilst enjoying
            some of the best food and drink on offer, delve into the past with
            the daily Discover Manchester Walking Tour, experience the city’s
            top attractions or explore the city’s streets looking for your next
            wardrobe favourite. Discover some of our favourite new experiences
            for visitors, and locals alike, below.{" "}
          </p>
      ...
      <div className="card">
        ...
        <div className="card-body">
          <p className="description">
            Fill your time in London with amazing experiences, and rediscover
            all the things you've missed in this incredible city. From free
            museums and world-class theatre, to foodie delights, serious
            shopping and unmissable attractions, there are exciting adventures
            waiting for you around every corner. So, whatever you’re planning on
            doing, do it all safely in London!{" "}
          </p>
